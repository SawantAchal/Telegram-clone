...
const formatTimestamp = (timestamp) => {
  ...
  return (
    <div className="flex flex-col h-screen">
      <div className="flex justify-between items-center p-4 bg-gray-200 dark:bg-gray-800 fixed top-0 left-0 right-0 border-b border-gray-300 dark:border-gray-700 z-10">
        <button onClick={() => navigate('/')} className="text-blue-500">
            <FaArrowLeft />
        </button>
        <div className="flex items-center">
